...
export default function NewsLetter() {
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-300">
              Get the latest updates, event notifications, and valuable insights
              delivered directly to your inbox. Join our community of food truck
              owners!
            </p>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                Stay informed with our weekly newsletters containing the latest
                news, event highlights, and valuable resources.
              </dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                Join us without worrying about spam. Our newsletters are curated
                to provide valuable insights and updates for food truck owners.
              </dd>
            </div>
          </dl>
        </div>
      ...
      >
        <div
          className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#08F] to-[#08F] opacity-30"
          style={{
            clipPath:
