...
const products = [
  ...
  {
    name: "Engagement",
    description: "Learn more about the food truck industry",
    href: "#",
    icon: CursorArrowRaysIcon,
  },
  {
    name: "Security",
    description: "Your company’s data will be safe and secure",
    href: "#",
  ...
  {
    name: "Analysis",
    description: "Create strategic parking locations",
    href: "#",
    icon: ArrowPathIcon,
  },
];
